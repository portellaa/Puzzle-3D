...
/* Valores da vista em perspectiva na coordenada Z */
#define ZNEARPERS 0.1
#define ZFARPERS 500

/* Valores da vista em projec��o na coordenada Z */
#define ZNEARORTH -20
#define ZFARORTH 20

/* Tamanho m�ximo de cada linha do ficheiro */
#define MAX_LINE_SIZE 200       //DEFAULT = 200

/* Tamannho duma aresta do cubo (comprimento/largura) */
#define CUBO_SIZE 0.2  //DEFAULT = HALF_CUBO_SIZE * 2

/* Velocidade que cada pe�a roda */
#define VEL_ROTACAO 6   //DEFAULT = 6   /* Velocidade de rota??o das anima??es quando premida uma tecla */ 

/* Velocidade da translac��o da pe�a -> Limites: ]0, 2] */
#define VEL_TRANSLACAO 2        //DEFAULT = 2   /* Velocidade de transla??o das anima??es quando premida uma tecla */ 

/* Caminhos para os ficheiros do niveis */
...
/* ----------------------------------------------------------------------------------------------------------------------*/
/* ---------------------------------------Valores que nao podes/devem ser alterados--------------------------------------*/

#define NUM_VERTICES_FACE 4     //DEFAULT = 4
#define NUM_FACES_CUBO 6        //DEFAULT = 6
#define HALF_CUBO_SIZE (CUBO_SIZE / 2.0)      //DEFAULT = 0.1
...
/* Dimensoes onde o cubo pode ser desenhado */
#define LIM_MAX_X 2.8
#define LIM_MIN_X -2.8
#define LIM_MAX_Y 2.8
#define LIM_MIN_Y -2.8
#define LIM_MAX_Z 0.4
#define LIM_MIN_Z -500
...
#define MINPERSPZ (8.0 + CUBO_SIZE)
